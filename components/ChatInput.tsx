      ...
      <div style={{ maxWidth: 820, margin: "0 auto" }}>
        ...
        {retryInfo && (
          <div style={{
            ...
            {t("input.retrying", { attempt: retryInfo.attempt, max: retryInfo.maxAttempts })}{retryInfo.errorMessage && <span style={{ opacity: 0.7, marginLeft: 4 }}> - {retryInfo.errorMessage}</span>}
          </div>
        )}
        {/* Image previews */}
          ...
          <textarea
            ...
            placeholder={
              isStreaming && (onSteer || onFollowUp)
                ? t("input.placeholder.queue")
                : isStreaming ? t("input.placeholder.running")
          ...
          <div style={{ flex: "0 0 auto", display: "flex", alignItems: "center", gap: 2, marginLeft: "auto" }}>
                ...
                {thinkingDropdownOpen && (
                  <div style={{
                    ...
                    {THINKING_LEVELS.filter((lvl) => {
                      ...
                      const desc = t(`input.thinking.${lvl}`);
                ...
                {toolDropdownOpen && (
                  <div style={{
                    ...
                    {TOOL_PRESETS.map((lvl) => {
                      ...
                      const desc = lvl === "off" ? t("input.tools.offDesc") : lvl === "default" ? t("input.tools.defaultDesc") : t("input.tools.fullDesc");
                      return (
                        <button
                          key={lvl}
            ...
            {!isStreaming && onCompact && (
              <div style={{ position: "relative" }}>
                ...
                <button
                  ...
                  title={isCompacting ? t("input.compact.stop") : t("input.compact.title")}
                >
                  {isCompacting ? (
                    <><svg width="10" height="10" viewBox="0 0 10 10" fill="none"><rect x="2" y="2" width="6" height="6" rx="1" fill="currentColor" /></svg>{t("input.compacting")}</>
                  ) : (
                    <><svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            {onSoundToggle !== undefined && (
              <button
                ...
                title={soundEnabled ? t("input.sound.off") : t("input.sound.on")}
                style={{
                  display: "flex", alignItems: "center", justifyContent: "center",
                  width: 32, height: 32, padding: 0,
                  background: "none",
