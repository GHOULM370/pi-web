        ...
        <div ref={dropdownRef} style={{ position: "relative" }}>
          ...
          >
            <span
              ...
              title={selectedCwd ?? ""}
            >
              {selectedCwd ? shortenCwd(selectedCwd, homeDir) : (initialSessionId && !restoredRef.current ? "" : t("sidebar.selectProject"))}
            </span>
          </button>
      ...
      {confirmDelete ? (
        ...
        <>
          <div style={{ flex: 1, minWidth: 0, fontSize: 12, color: "var(--text)", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
            {t("sidebar.deletePrompt", { title: `${title.slice(0, 22)}${title.length > 22 ? "..." : ""}` })}
          </div>
        ...
        <>
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <div style={{ marginTop: 2, display: "flex", gap: 8, color: "var(--text-dim)", fontSize: 11 }}>
              ...
              <span>{t("sidebar.messages", { count: session.messageCount })}</span>
            </div>
          </div>
